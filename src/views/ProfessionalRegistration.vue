            ...
            <div class="card border-0 shadow-lg rounded">
              <div class="card-body p-4 p-md-5">
                ...
                <form @submit.prevent="handleSubmit" novalidate>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control form-control-lg" 
                        ...
                        @blur="validateField('username')" @input="errors.username = ''" 
                  ...
                  <div class="row">
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="number" class="form-control form-control-lg" 
                        ...
                        id="age" v-model="formData.age" 
                        @blur="validateField('age')" @input="errors.age = ''" 
                        placeholder="35">
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <select class="form-control form-control-lg" 
                        ...
                        @blur="validateField('gender')" @change="validateField('gender')">
                  ...
                  <div class="mb-3">
                    <label for="related_docs" class="form-label fw-bold">Upload License/Certification <span class="text-danger">*</span></label>
                    <input type="file" class="form-control form-control-lg" 
                      :class="{ 'is-invalid': errors.related_docs }"
                      id="related_docs" 
                  ...
                  <div class="mb-3">
                    <label for="bio" class="form-label fw-bold">Professional Bio <span class="text-danger">*</span></label>
                    <textarea class="form-control form-control-lg" rows="5"
                      :class="{ 'is-invalid': errors.bio }"
                      id="bio" v-model="formData.bio" 
                      @blur="validateField('bio')" @input="errors.bio = ''" 
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <div class="input-group">
                        <input :type="showConfirmPassword ? 'text' : 'password'" 
                          ...
                          @blur="validateField('confirmPassword')" @input="errors.confirmPassword = ''" 
                  ...
                  <p class="text-center mt-2 text-muted">
                    ...
                    <router-link to="/register" class="text-primary fw-bold text-decoration-none">Register as a patient</router-link>
                  </p>
                </form>
              </div>
            </div>
