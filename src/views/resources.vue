        ...
        <div class="header-content">
          ...
          <div class="header-notes">
            <div class="note-item">
              ...
              <span>All resources are static links</span>
            </div>
            <div class="note-item">
              <span class="note-icon">🔗</span>
              <span>Links open external websites</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="banner-container">
        ...
        <div class="emergency-numbers">
          <div class="number-card">
            ...
            <div class="number-label">Suicide & Crisis Lifeline</div>
          </div>
          <div class="number-card">
            <div class="number">741741</div>
            <div class="number-label">Crisis Text Line (Text HOME)</div>
          </div>
          <div class="number-card">
      ...
      <div class="footer-container">
        <div class="footer-content">
          <div class="footer-info">
            <h4 class="footer-title">Mental Wellness Resources</h4>
            <p class="footer-description">
              A static collection of mental health resources for educational purposes.
          ...
          <div class="footer-disclaimer">
            ...
            <div class="disclaimer-text">
              <strong>Important:</strong> This page contains external links to third-party websites. 
              We are not affiliated with these resources. In emergencies, contact professional help immediately.
            </div>
          </div>
        </div>
        <div class="footer-bottom">
          <p class="copyright">© 2024 Mental Wellness Resources • Static Page</p>
        </div>
      </div>
    </footer>
  </div>
